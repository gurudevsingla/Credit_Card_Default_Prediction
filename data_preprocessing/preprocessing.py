...
class Preprocessor:
    ...
    #            self.data[col] = selfimputer.fit_transform(self.data[col])
    ...
    def remove_id_column(self,data):
        """
                                                        Method Name: remove_id_column
                                                        Description: This method removes the id column which is not contributing.
                                                        Output: A dataframe without id column.
                                                        On Failure: Raise Exception
                                                        ...
                                                        Revisions: None
                                             """
        self.logger_object.log(self.file_object, 'Entered the remove_id_column method of the Preprocessor class')
        self.data = data
        try:
            self.useful_data=self.data.drop(labels=['ID'], axis=1)

            self.logger_object.log(self.file_object,'ID Column removal Successful.Exited the remove_id_column method of the Preprocessor class')
            return self.useful_data

        except Exception as e:
            self.logger_object.log(self.file_object,'Exception occured in remove_id_column method of the Preprocessor class. Exception message:  ' + str(e))
            self.logger_object.log(self.file_object,'ID Column removal Unsuccessful. Exited the remove_id_columns method of the Preprocessor class')
            raise Exception()
    ...
    def scale_numerical_columns(self,data):
        ...
        try:
            self.num_df = self.data.select_dtypes(exclude=['object']).copy()
